...
| **thumbnail-maker** | Miniaturas de video — siempre un set A/B de 4+ variantes, generación en un solo paso con el texto incluido (verificado letra a letra), solo recortes de rostros reales como referencia |
